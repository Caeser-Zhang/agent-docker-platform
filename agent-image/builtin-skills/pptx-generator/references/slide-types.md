...
4. **Verify**: Generate preview as `slide-XX-preview.pptx`. Extract text with `pptx-markitdown slide-XX-preview.pptx`, verify all content present and no placeholder text remains.
